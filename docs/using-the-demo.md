...
you see is the route you walked and nothing besides: drift adds nothing, and nothing already
on screen ever moves on its own. Pan far enough and the centre goes off screen along with the
doorways standing around it; **Recentre** is the way back, and clicking anything you can see
is the way on. What the map draws around the centre, and why none of it moves, is
